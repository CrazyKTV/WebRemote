...
<div>
    <asp:Label ID="Label1" runat="server" Text="Functions: " meta:resourcekey="Label1Resource1"></asp:Label><asp:DropDownList ID="DDActions" runat="server" AutoPostBack="True" meta:resourcekey="DDActionsResource1">
