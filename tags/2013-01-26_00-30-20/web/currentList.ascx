...
<asp:ScriptManagerProxy ID="ScriptManagerProxy1" runat="server">
  ...
  <section>
    ...
    <%# Container.DataItemIndex + 1 %>
                ...
                <ItemStyle CssClass="dgLang" HorizontalAlign="Left" />
            </asp:TemplateField>
            ...
            <asp:ButtonField ButtonType="Button" CommandName="Insert" HeaderText="D" Text="Del" meta:resourcekey="ButtonFieldResource1" Visible="False">
