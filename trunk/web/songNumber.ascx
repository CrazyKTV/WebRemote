...
<article>
    ...
    <asp:TextBox ID="tSongNumber" runat="server" Width="74px" CssClass="textbox2" meta:resourcekey="tSongNumberResource1" OnPreRender="tSongNumber_PreRender"></asp:TextBox>
