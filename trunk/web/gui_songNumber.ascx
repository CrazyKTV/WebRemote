<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="gui_songNumber.ascx.cs" Inherits="web.gui_songNumber" %>
...
<article>
    ...
    <asp:TextBox type="number" ID="tSongNumber" runat="server"  Width="100px" CssClass="textbox2" meta:resourcekey="tSongNumberResource1" OnPreRender="tSongNumber_PreRender"></asp:TextBox>
